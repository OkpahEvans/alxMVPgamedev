...
export class StandingLeft extends State {
    constructor(player) {
        // to access and call methods on object's parent
        super('STANDING LEFT')
        this.player = player
    }
    // polymorphism allows methods to display different behaviour depending
    ...
    handleInput(input) {
        if (input === 'PRESS right') this.player.setState(states.RUNNING_RIGHT) // set state to RunningRight    
...
export class StandingRight extends State {
    ...
    handleInput(input) {
        if (input === 'PRESS left') this.player.setState(states.RUNNING_LEFT) // set state to RunningLeft
