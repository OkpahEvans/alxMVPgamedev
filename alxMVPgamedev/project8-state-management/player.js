...
export default class Player {
    constructor(gameWidth, gameHeight) {
        ...
        this.width = 200
        this.height = 181.83
        this.x = this.gameWidth / 2 - this.width / 2 // center placement
        this.y = this.gameHeight - this.height // bottom center placement
        this.frameX = 0
        this.frameY = 0
        this.maxFrame = 6
        this.speed = 0
    ...
    update(input) {
        ...
        else if (this.x >= this.gameHeight - this.width) this.x = this.gameHeight - this.width
